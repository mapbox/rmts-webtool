...
export function initCFunctions() {
    ...
    GDALFunctions.GDALGetRasterBand = Module.cwrap('GDALGetRasterBand', 'number', ['number']);
    ...
    GDALFunctions.GDALDEMProcessing = Module.cwrap('GDALDEMProcessing', 'number', [
        'string', // char * the destination dataset path or NULL.
        'number', // the source dataset handle.
        'string', // the processing to apply (one of "hillshade", "slope", "aspect", "color-relief", "TRI", "TPI", "Roughness")
        'string', // color file (mandatory for "color-relief" processing, should be NULL otherwise)
        'number', // the options struct returned by GDALDEMProcessingOptionsNew() or NULL.
        'number', // int * pbUsageError
    ])
    GDALFunctions.GDALDEMProcessingOptionsNew = Module.cwrap('GDALDEMProcessingOptionsNew', 'number', ['number', 'number']);
    GDALFunctions.GDALDEMProcessingOptionsFree = Module.cwrap('GDALDEMProcessingOptionsFree', 'number', ['number']);
